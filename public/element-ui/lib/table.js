...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/table/src/table.vue?vue&type=template&id=306e6a04&
var render = function () {
  var _vm = this
      ...
      _c(
        ...
        [
          _c(
            "el-scrollbar",
            {
              ref: "bodyWrapperScrollbar",
              style: [_vm.bodyScrollHeight],
              attrs: { "wrap-style": [_vm.bodyScrollWrapHeight] },
            },
            [
              _c("table-body", {
                style: {
...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=306e6a04&
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    syncPostion: Object(external_throttle_debounce_["throttle"])(20, function () {
      ...
      var _bodyWrapperScrollbar = this.bodyWrapperScrollbar,
          scrollLeft = _bodyWrapperScrollbar.scrollLeft,
          scrollTop = _bodyWrapperScrollbar.scrollTop,
          offsetWidth = _bodyWrapperScrollbar.offsetWidth,
          scrollWidth = _bodyWrapperScrollbar.scrollWidth;
  ...
  computed: tablevue_type_script_lang_js_extends({
    ...
    bodyWrapperScrollbar: function bodyWrapperScrollbar() {
    ...
    bodyScrollHeight: function bodyScrollHeight() {
      var _layout3 = this.layout,
          _layout3$headerHeight = _layout3.headerHeight,
          headerHeight = _layout3$headerHeight === undefined ? 0 : _layout3$headerHeight,
          _layout3$footerHeight = _layout3.footerHeight,
          footerHeight = _layout3$footerHeight === undefined ? 0 : _layout3$footerHeight;
    ...
    bodyScrollWrapHeight: function bodyScrollWrapHeight() {
      var _layout4 = this.layout,
          _layout4$headerHeight = _layout4.headerHeight,
          headerHeight = _layout4$headerHeight === undefined ? 0 : _layout4$headerHeight,
          bodyHeight = _layout4.bodyHeight,
          _layout4$footerHeight = _layout4.footerHeight,
          footerHeight = _layout4$footerHeight === undefined ? 0 : _layout4$footerHeight;

      if (this.height) {
        return {
          height: bodyHeight ? bodyHeight + scrollbar_width_default()() + 'px' : ''
        };
      } else if (this.maxHeight) {
        var maxHeight = Object(util["j" /* parseHeight */])(this.maxHeight);
        if (typeof maxHeight === 'number') {
          return {
            'height': maxHeight - footerHeight - (this.showHeader ? headerHeight : 0) + scrollbar_width_default()() + 'px'
          };
        }
      }
      return {};
    ...
    emptyBlockStyle: function emptyBlockStyle() {
      var _layout5 = this.layout,
          bodyHeight = _layout5.bodyHeight,
          appendHeight = _layout5.appendHeight;

      if (this.data && this.data.length) return null;
      // let height = '100%';
      var height = bodyHeight + 'px';
